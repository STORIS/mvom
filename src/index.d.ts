...
declare namespace mvom {
	...
	class Model extends Document {
		...
		static findAndCount(
			selectionCriteria?: GenericObject,
			options?: FindOptions,
		): Promise<{
			documents: Model[];
			count: number;
	...
	class Document {
		constructor(
			schema: Schema | null,
			options?: { data?: GenericObject; isSubdocument?: boolean; record?: RecordTemplate },
		);
	...
	export type SchemaPropertyTypes =
		...
		| SchemaISOCalendarDateProperty
		| SchemaISOCalendarDateTimeProperty
		| SchemaISOTimeProperty;
