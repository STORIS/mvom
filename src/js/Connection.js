 ...
 * @param {string} options.connectionManagerUri - URI of the connection manager which facilitates access to the mv database
...
class Connection {
	...
	constructor({ connectionManagerUri, account, logger, cacheMaxAge, timeout }) {
		...
		Object.defineProperties(this, {
			 ...
			 */
			status: {
				value: CONNECTION_STATUS.DISCONNECTED,
				enumerable: true,
				writable: true,
			},
			/**
